...
Route::middleware(['auth', 'verified', 'menu.permission'])->prefix('admin')->as('admin.')->group(function () {
    ...
    Route::prefix('masterdata')->as('masterdata.')->group(function () {
        ...
        Route::get('/items/inactive', [\App\Http\Controllers\Admin\ItemController::class, 'inactive'])->name('items.inactive');
    ...
    Route::prefix('inventory')->as('inventory.')->group(function () {
        ...
        Route::get('/stock-mutations/export', [StockMutationController::class, 'export'])->name('stock-mutations.export');
    ...
    Route::prefix('inbound')->as('inbound.')->group(function () {
        ...
        Route::get('/returns/{id}/edit', [InboundController::class, 'returnsEdit'])->name('returns.edit');
