...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        $menuRows = [
            ...
            ['name' => 'Laporan Retur', 'slug' => 'report-returns', 'route' => 'admin.reports.returns.index', 'icon' => 'fa-solid fa-arrow-right-arrow-left', 'parent_slug' => 'reports', 'sort_order' => 1.2],
            ['name' => 'Forecast Pengadaan', 'slug' => 'report-stock-forecast', 'route' => 'admin.reports.stock-forecast.index', 'icon' => 'fa-solid fa-chart-area', 'parent_slug' => 'reports', 'sort_order' => 1.21],
            ...
            ['name' => 'Laporan Stok Per Tanggal', 'slug' => 'report-stock-as-of', 'route' => 'admin.reports.stock-as-of.index', 'icon' => 'fa-solid fa-calendar-day', 'parent_slug' => 'reports', 'sort_order' => 1.23],
