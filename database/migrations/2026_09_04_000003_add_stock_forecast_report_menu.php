...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('menus')->updateOrInsert(
            ['slug' => 'report-stock-forecast'],
            [
                'name' => 'Forecast Pengadaan',
                'route' => 'admin.reports.stock-forecast.index',
        ...
        $menuId = DB::table('menus')->where('slug', 'report-stock-forecast')->value('id');
    ...
    public function down(): void
    {
        ...
        DB::table('menus')->where('slug', 'report-stock-forecast')->delete();
    }
};
